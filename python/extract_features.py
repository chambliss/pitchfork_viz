from utils.feat_ext import (get_table_contents, create_id_column, get_unique_artists, get_unique_genres, create_ents_df, create_pos_df, extract_features_from_reviews)
import os
import pandas as pd
import sqlite3
import spacy
...
if __name__ == "__main__":
    ...
    combined_ents_df.to_csv('../data/review_entities.csv')
    combined_pos_df.to_csv('../data/review_poses.csv')
